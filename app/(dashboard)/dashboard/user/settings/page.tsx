const UserSettingsPage = () => (
  <div className="space-y-6 max-w-2xl">
    ...
    <div className="bg-white dark:bg-background-dark rounded-2xl border border-slate-100 dark:border-slate-800 divide-y divide-slate-100 dark:divide-slate-800">
      {[
    ...
    <div className="bg-white dark:bg-background-dark rounded-2xl border border-rose-100 dark:border-rose-900/30 p-6">
