            ...
            <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
              <td className="px-8 py-5">
                <div className="flex items-center gap-4">
                  <div className="size-11 rounded-full bg-slate-200/50 dark:bg-background-dark shrink-0" />
              ...
              <td className="px-8 py-5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="h-3 w-40 bg-slate-200/50 dark:bg-background-dark rounded" />
                </div>
              </td>
              <td className="px-8 py-5">
                <div className="h-5 w-16 bg-slate-200/50 dark:bg-background-dark rounded" />
              </td>
