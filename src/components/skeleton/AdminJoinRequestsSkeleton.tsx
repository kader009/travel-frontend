export const SentJoinRequestsSkeleton = () => {
  return (
    <div className="space-y-4 w-full animate-pulse fade-in duration-500">
      {[1, 2, 3].map((i) => (
         <div key={i} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-6 rounded-4xl flex flex-col md:flex-row items-start md:items-center gap-6 shadow-sm">
...
export const ReceivedJoinRequestsSkeleton = () => {
  return (
    <div className="space-y-8 w-full animate-pulse fade-in duration-500">
      <div className="space-y-8">
        {[1, 2].map((i) => (
          <div key={i} className="space-y-4 max-w-2xl mx-auto px-4 w-full">
            ...
            <div className="space-y-3">
              {[1, 2].map((j) => (
                <div key={j} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-6 rounded-3xl flex flex-col gap-5 shadow-sm w-full">
