            ...
            <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
              <td className="px-8 py-5">
                <div className="flex items-center gap-4">
                  <div className="size-11 rounded-xl bg-slate-200/50 dark:bg-slate-700 shrink-0" />
                  <div>
                    <div className="h-4 w-32 bg-slate-200/50 dark:bg-slate-700 rounded mb-2" />
                    <div className="h-2 w-16 bg-slate-200/50 dark:bg-slate-700 rounded" />
                  </div>
                </div>
              </td>
              <td className="px-8 py-5">
                <div className="flex items-center gap-2">
                  <div className="size-3.5 rounded-full bg-slate-200/50 dark:bg-slate-700 shrink-0" />
              ...
              <td className="px-8 py-5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="h-3 w-28 bg-slate-200/50 dark:bg-slate-700 rounded" />
                </div>
              </td>
              <td className="px-8 py-5">
                <div className="flex items-center gap-1.5">
                  <div className="size-3.5 rounded-sm bg-slate-200/50 dark:bg-slate-700 shrink-0" />
                  <div className="h-3 w-16 bg-slate-200/50 dark:bg-slate-700 rounded" />
                </div>
              </td>
