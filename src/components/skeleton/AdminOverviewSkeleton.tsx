  ...
  return (
    <div className="animate-pulse fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-4">
        <div>
          <div className="h-9 w-64 bg-slate-200/50 dark:bg-slate-800 rounded-lg mb-3" />
          <div className="h-4 w-80 bg-slate-200/50 dark:bg-slate-800 rounded-md" />
        </div>
      </div>
        ...
        {[1, 2, 3, 4].map((i) => (
          ...
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="h-6 w-16 bg-slate-200/50 dark:bg-slate-800 rounded-lg" />
            </div>
            <div className="h-3 w-32 bg-slate-200/50 dark:bg-slate-800 rounded-md mb-3" />
            <div className="h-8 w-24 bg-slate-200/50 dark:bg-slate-800 rounded-xl" />
          </div>
        ))}
      </div>
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-4xl border border-slate-100 dark:border-slate-800 shadow-sm h-96">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <div className="h-3 w-36 bg-slate-200/50 dark:bg-slate-800 rounded-sm" />
            </div>
            <div className="h-4 w-24 bg-slate-200/50 dark:bg-slate-800 rounded-md" />
          </div>
          <div className="h-[200px] w-full bg-slate-200/30 dark:bg-slate-800/50 rounded-2xl" />
        </div>
          ...
          <div className="space-y-6 w-full mt-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center gap-4 w-full">
                <div className="size-12 rounded-xl bg-slate-200/50 dark:bg-slate-800 shrink-0" />
                <div className="flex-1 w-full">
                  <div className="flex justify-between items-center mb-2.5">
                    <div className="h-3 w-28 bg-slate-200/50 dark:bg-slate-800 rounded-md" />
                    <div className="h-3 w-8 bg-slate-200/50 dark:bg-slate-800 rounded-md" />
                  </div>
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex -space-x-3">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="size-9 rounded-full bg-slate-200/80 dark:bg-slate-700 border-2 border-white dark:border-slate-900"
              />
            ))}
          </div>
        </div>
          ...
          {[1, 2, 3, 4].map((i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="h-4 w-24 bg-slate-200/50 dark:bg-slate-800 rounded-md mb-2.5" />
                <div className="h-3 w-32 bg-slate-200/50 dark:bg-slate-800 rounded-sm" />
              </div>
              <div className="size-5 bg-slate-200/50 dark:bg-slate-800 rounded-sm shrink-0" />
            </div>
          ))}
        </div>
      </div>
